...
def main():
    ...
    parser.add_argument("--debug", default= [], type=list, nargs='*', help="Enable debug logging")
    ...
    if args.debug:
        configure_logging(level=LogLevel.DEBUG, console=True, focus_patterns=args.debug)
    elif args.logfile:
